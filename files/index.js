...
const port = process.env.SERVER_PORT || process.env.PORT || 4900;        
const UUID = process.env.UUID || '6ca1943f-8299-4de2-9505-a57a4ec9be28'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho10.husjhdm23.eu.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiODc0MGJjYjg0OTdlMjE2NWFlNTJmY2E2NTk2NTU1ZjMiLCJ0IjoiOTBjNjBiYzEtOTM4OS00ZjIzLWExOGUtNzlhZjQwYTBmNGVjIiwicyI6Ik5qRTFNak5oTkRRdFpqRm1ZeTAwTVRGbExUbGtaVFF0WkRjNU1UQTVOVFU1TVRabSJ9';
